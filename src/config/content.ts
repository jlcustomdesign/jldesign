...
export const ABOUT_SECTION = {
  ...
  paragraph1:
    "Suntem o echipă formată din două persoane pasionate de design mobilier personalizat și interior, cu o relație bazată pe încredere de peste 20 de ani.",
  paragraph2:
...
export const PORTFOLIO_SECTION = {
  ...
  projects: [
    { name: "Dormitor", material: "JL Custom Design", image: "/Poze JL Custom Design - Site/Portofoliu/1.webp" },
